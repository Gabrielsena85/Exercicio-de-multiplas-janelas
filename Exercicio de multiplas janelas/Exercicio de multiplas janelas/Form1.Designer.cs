namespace Exercicio_de_multiplas_janelas
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            buttonAdicionarProduto.BackColor = Color.Lime;
            ...
            // 
            buttonRemoverProduto.BackColor = Color.Red;
            ...
            // buttonViewProdutos
            // 
            buttonViewProdutos.BackColor = Color.LawnGreen;
            ...
            // buttonViewClientes
            // 
            buttonViewClientes.BackColor = Color.LawnGreen;
            buttonViewClientes.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            buttonViewClientes.ForeColor = Color.FromArgb(64, 0, 64);
            buttonViewClientes.Image = (Image)resources.GetObject("buttonViewClientes.Image");
            ...
            // buttonViewVendas
            // 
            buttonViewVendas.BackColor = Color.LawnGreen;
            buttonViewVendas.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            buttonViewVendas.ForeColor = Color.FromArgb(64, 64, 0);
            buttonViewVendas.Image = (Image)resources.GetObject("buttonViewVendas.Image");
            ...
            // 
            buttonViewFornecedores.BackColor = Color.LawnGreen;
            buttonViewFornecedores.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            buttonViewFornecedores.ForeColor = Color.FromArgb(0, 64, 64);
            buttonViewFornecedores.Image = (Image)resources.GetObject("buttonViewFornecedores.Image");
            ...
            // buttonViewCompras
            // 
            buttonViewCompras.BackColor = Color.LawnGreen;
            buttonViewCompras.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            buttonViewCompras.ForeColor = Color.FromArgb(0, 0, 64);
            buttonViewCompras.Image = (Image)resources.GetObject("buttonViewCompras.Image");
            ...
            // 
            buttonAdicionarVenda.BackColor = Color.Lime;
            ...
            // buttonRemoverVenda
            // 
            buttonRemoverVenda.BackColor = Color.Red;
            ...
            // 
            buttonAdicionarFornecedor.BackColor = Color.Lime;
            ...
            // 
            buttonRemoverFornecedor.BackColor = Color.Red;
            ...
            // 
            buttonAdicionarCompra.BackColor = Color.Lime;
            ...
            // buttonRemoverCompra
            // 
            buttonRemoverCompra.BackColor = Color.Red;
